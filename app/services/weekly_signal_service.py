...
BLUE_CHIPS = [
    "AC", "SM", "BDO", "JFC", "TEL", "MER", "GLO", "ALI", "AEV", "MBT",
    "BPI", "SMC", "AP", "URC", "ICT", "DMC", "MEG", "RLC", "PGOLD", "CNVRG",
    "SECB", "FLI", "MPI", "GTCAP", "AGI", "FGEN", "CEB", "EMP", "LTG", "PHR"
]
...
def generate_all_weekly_signals():
    """Run weekly signal generation for all blue chips and save to Firestore."""
...
def manual_refresh_signals():
    """Manually trigger weekly signal calculation."""
